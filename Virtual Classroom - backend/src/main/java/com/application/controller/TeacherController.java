...
//		}
	...
	@CrossOrigin(origins = "http://localhost:4200")
	public String addNewCourse(@RequestBody Course course) throws Exception
	{
	...
	@CrossOrigin(origins = "http://localhost:4200")
	public String addNewChapters(@RequestBody Chapter chapter) throws Exception
	{
		String chapterObj = null;
	...
	{
		String teacherobj = teacherService.updateteacherProfile(teacher);
